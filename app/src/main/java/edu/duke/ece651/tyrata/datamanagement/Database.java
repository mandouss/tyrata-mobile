...
public class Database extends AppCompatActivity {
    ...
    public static void storeUserData(String username, String password){


        myDatabase.execSQL("CREATE TABLE IF NOT EXISTS users (Name VARCHAR, Password VARCHAR)");
        myDatabase.execSQL("INSERT INTO users VALUES ('"+username+"', '"+password+"')");
    ...
    public static void storeTireData(String username, String carmodel, String tiremodel, String tireyear, String vin){
    ...
    public static String carModelLoaddata(String username){
        //myDatabase = openOrCreateDatabase("Users", MODE_PRIVATE, null);
    ...
    public static String tireModelLoaddata(String username){
        //myDatabase = openOrCreateDatabase("Users", MODE_PRIVATE, null);
        Cursor a = myDatabase.rawQuery("SELECT * FROM info WHERE Name ="+username, null);
    ...
    public static String tireYearLoaddata(String username){
        //myDatabase = openOrCreateDatabase("Users", MODE_PRIVATE, null);
        Cursor a = myDatabase.rawQuery("SELECT * FROM info WHERE Name ="+username, null);
    ...
    public static String VINLoaddata(String username){
        //myDatabase = openOrCreateDatabase("Users", MODE_PRIVATE, null);
        Cursor a = myDatabase.rawQuery("SELECT * FROM info WHERE Name ="+username, null);
